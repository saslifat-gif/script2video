...
Script2Video Studio v1.0.12 is packaged as a 64-bit, per-user Windows
...
Python 3.11 + Script2Video + Kokoro + pywebview
    ...
    -> Script2Video-Studio-1.0.12-Windows-x64.exe
```
...
```text
release/Script2Video-Studio-1.0.12-Windows-x64.exe
```
...
8. Create the `v1.0.12` GitHub release only after this smoke test passes.
